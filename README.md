...
Eleven topics, built in order. Nine shipped; T10's harness is written, tested and rehearsed
with its bands pre-registered, awaiting a single-GPU session. T11 is scoped and planned.
